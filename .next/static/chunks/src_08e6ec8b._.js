...
"[project]/src/components/ExportModal.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ExportModal(param) {
    let { ranked, criteria, onClose, sn } = param;
    const doCSV = ()=>{
        const header = [
            'Hạng',
            'Mã đội',
        ...
        const rows = ranked.map((t)=>[
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calcScore"])(t.scores, criteria).toFixed(2)
            ]);
        const csv = [
            header,
            ...rows
...
"[project]/src/pages/LeaderboardPage.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function LeaderboardPage(param) {
    let { teams, criteria, sortBy, setSortBy, onEdit, onExport } = param;
    const sorted = [
        ...teams
    ].sort((a, b)=>sortBy === 'score' ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calcScore"])(b.scores, criteria) - (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calcScore"])(a.scores, criteria) : sortBy === 'id' ? a.id.localeCompare(b.id) : a.name.localeCompare(b.name));
    const byScore = [
        ...teams
    ].sort((a, b)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calcScore"])(b.scores, criteria) - (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calcScore"])(a.scores, criteria));
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    {
                        l: 'Điểm cao nhất',
                        v: Math.max(...teams.map((t)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calcScore"])(t.scores, criteria))).toFixed(2)
                    },
                    {
                        l: 'Điểm trung bình',
                        v: (teams.reduce((a, t)=>a + (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calcScore"])(t.scores, criteria), 0) / teams.length).toFixed(2)
                    },
                    {
                        l: 'Tổng đội thi',
                        v: "".concat(teams.length, " đội")
                    }
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                style: {
                    gridTemplateColumns: "56px 1fr ".concat(criteria.map(()=>'72px').join(' '), " 84px 110px"),
                    color: '#757575',
            ...
            ranked.map((t, i)=>{
                ...
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    style: {
                        gridTemplateColumns: "56px 1fr ".concat(criteria.map(()=>'72px').join(' '), " 84px 110px"),
                        background: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRankBg"])(t.rank),
                        border: "1px solid ".concat(t.rank <= 3 ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRankColor"])(t.rank) + '55' : '#e5e5e5'),
                        borderRadius: 2,
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            style: {
                                ...
                                color: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRankColor"])(t.rank)
                            },
                            children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRankIcon"])(t.rank)
                        }, void 0, false, {
                            fileName: "[project]/src/pages/LeaderboardPage.jsx",
                            lineNumber: 62,
                            columnNumber: 13
                        ...
                        criteria.map((_, ci)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
"[project]/src/utils/scoreUtils.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const rankIcon = (r)=>r === 1 ? '🥇' : r === 2 ? '🥈' : r === 3 ? '🥉' : "#".concat(r);
...
const getStatusLabel = (status)=>{
    var _STATUS_LABELS_status;
    return (_STATUS_LABELS_status = STATUS_LABELS[status]) !== null && _STATUS_LABELS_status !== void 0 ? _STATUS_LABELS_status : status;
};
const getStatusBadgeClass = (status)=>{
    ...
    var _map_status;
    return (_map_status = map[status]) !== null && _map_status !== void 0 ? _map_status : 'bdg-w';
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ExportModal$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ExportModal.jsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$pages$2f$LeaderboardPage$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/pages/LeaderboardPage.jsx [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$scoreUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/scoreUtils.js [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function LeaderboardRoute() {
    ...
    const sn = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "LeaderboardRoute.useCallback[sn]": function(m) {
            ...
            setTimeout({
                "LeaderboardRoute.useCallback[sn]": ()=>setNotif(null)
            }["LeaderboardRoute.useCallback[sn]"], 3000);
        }
    }["LeaderboardRoute.useCallback[sn]"], []);
    const ranked = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "LeaderboardRoute.useMemo[ranked]": ()=>[
                ...teams
            ].sort({
                "LeaderboardRoute.useMemo[ranked]": (a, b)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$scoreUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calcScore"])(b.scores, criteria) - (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$scoreUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calcScore"])(a.scores, criteria)
            }["LeaderboardRoute.useMemo[ranked]"])
    }["LeaderboardRoute.useMemo[ranked]"], [
        teams,
        criteria
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            ...
            showExp && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ExportModal$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                ranked: ranked,
                criteria: criteria,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$pages$2f$LeaderboardPage$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                    teams: teams,
                    criteria: criteria,
                    sortBy: sortBy,
                    setSortBy: setSortBy,
...
_s(LeaderboardRoute, "Y4B3VNvy1ZFP4GRAtqZhxqGD0JI=");
_c = LeaderboardRoute;
var _c;
__turbopack_context__.k.register(_c, "LeaderboardRoute");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_08e6ec8b._.js.map